        ...
        $("#contentGr").empty().append($("<form action='' name='frmER' id='frmER' method='post' enctype='multipart/form-data'>"
            ...
            $("#P-data").append($("<div class='col-lg-12 row'><div class='row col-lg-6'><span id='DP'>HN : "+data[0].hn+"<br>เลขบัตรประชาชน : "+data[0].cid+"<br>ชื่อ-สกุล :"+data[0].fullname
                                ...
                                ,$("<div class='col-lg-12 row'>"
                                    +"<div class='form-group col-lg-4 row'><div class='form-group form-check col-sm-4'><input name='relative_chk' class='form-check-input' type='checkbox' /><label class='form-check-label' for='relative'>ญาตินำส่ง</label></div>"
                                    ...
                                    +"</div>"
                                    +"<div class='form-group col-lg-5 row'><div class='form-group form-check col-sm-4'><input name='police_chk' class='form-check-input' type='checkbox' /><label class='form-check-label' for='police_name'>ตำรวจ/มูลนิธินำส่ง </label></div>"
                                    +"<div class='col-sm-8 row'><input class='form-control form-control-sm' type='text' id='police_name' name='police_name' placeholder='ชื่อหน่วยงาน' /></div> "
                                    +"</div>"
                                +"</div>")
                                ,$("<hr>")
                                ...
                                +"<div class='col-sm-2'></div><div class='col-sm-2'><label><input class='ace' type='checkbox' name='typeP_6' value='6'><span class='lbl'> พรบ. 120 ยาเสพติด</span></label></div><div class='col-sm-1'><label><input class='ace' type='checkbox' name='typeP_7' value='7'><span class='lbl'> พรบ.สุรา</span></label></div></div>")
                                ,$("<hr>")
                                ...
                                ,$("<div class='form-group row'><label class='col-sm-5 col-form-label'><b>การสูบบุรี่ </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='cigarette_chk' value='N'checked required><span class='lbl'> ไม่สูบ</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='cigarette_chk' value='Y' required><span class='lbl'> สูบ</span></label></div></div>")
                                ,$("<div class='row' id='cigarette'>"
                                    +"<div class='col-lg-12 row'>"
                                    +"<div class='form-group col-lg-4 row'><div class='form-group form-check col-sm-4'><label class='form-check-label' for='D_cigarette'>ระบุรายละเอียด</label></div>"
                                    ...
                                    +"</div>"
                                    +"<div class='form-group col-lg-5 row'><div class='form-group form-check col-sm-4'><label class='form-check-label' for='last_useC'>ใช้ครั้งสุดท้าย </label></div>"
                                ...
                                ,$("<div class='row' id='alcohol'>"
                                    ...
                                    +"</div>"
                                    +"<div class='form-group col-lg-4 row'><div class='form-group form-check col-sm-4'><label class='form-check-label' for='last_useA'>ใช้ครั้งสุดท้าย </label></div>"
                                ...
                                ,$("<div class='row' id='marihuana'>"
                                    ...
                                    +"</div></div>")
                                ,$("<hr>")
                                ,$("<div class='form-group row'><label class='col-sm-2 col-form-label'><b>ADL </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='ADL' value='1' checked><span class='lbl'> ทำเองได้</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='ADL' value='2'><span class='lbl'> ทำได้บางส่วน</span></label></div>"
                                    +"<div class='col-sm-2'><label><input class='ace' type='radio' name='ADL' value='3'><span class='lbl'> ญาติต้องดูแล</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='ADL' value='4'><span class='lbl'> ญาติทำให้ทั้งหมด</span></label></div></div>")
                                    ,$("<hr>")
