function AssNPIQ(content, id = null) {
    ...
    //     $("#body_text").empty().append("<b>เบิกครั้งที : " + data[0].ID + " เลขที่เบิก : " + data[0].bill_no + " วันที่ : " + data[0].bill_date + " หน่วยงาน : " + data[0].department_name + "</b><p>");
        ...
        $("#contentGr").empty().append($("<form action='' name='frmDoc01' id='frmDoc01' method='post' enctype='multipart/form-data'>"
            ...
            $("#ass-NPIQ").append($("<div class='card border-success'><div class='card-header'><label class='col-lg-12 col-form-label'><b>1. ความคิดหงุดหงิด : ท่านคิดว่าผู้ป่วยมีความเชื่อในสิ่งที่ไม่เป็นจริงมั้ย? ตัวอย่างเช่น ผู้ป่วยพูดบ่อยๆว่าจะมีคนมาคอยทำร้ายหรือขโมยของจากเข้า หรือผู้ป่วยพูดว่าคนในบ้านไม่ใช่คนเดิมที่เขารู้จักหรือบ้านที่ผู้ป่วยอยู่ไม่ใช่หลังเดิมที่เขาเคยอยู่ โดยไม่ใช่แค่คิดสงสัย แต่ผู้ป่วยมั่นใจว่าสิ่งที่คิดเป็นจริง </b></label>"
