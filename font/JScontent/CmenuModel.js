...
$("#createModal").empty().append("<div class='modal' id='ChildModal' role='dialog' aria-labelledby='exampleModalLabel'>"
  ...
  $('span#his_detail').empty().append($("<div class='col-md-12 col-lg-12'><a id='child' class='btn btn-success btn-block' href='#'><img src='images/Px.ico' width='35'><b> บันทึก SNAP-IV</b></a></div><br>")
