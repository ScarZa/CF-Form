function AssMENU(content, id = null) {
    ...
    $("div#menu").empty().append($("<div class='col-md-12 col-lg-12'><a id='alcohol' class='btn btn-success btn-block' href='#'><img src='images/beer.ico' width='25'><b> ประเมินผู้ป่วยสุรา</b></a></div><br>")
                                ...
                                ,$("<div class='col-md-12 col-lg-12'><a id='test' class='btn btn-success btn-block' href='#' data-toggle='modal' data-target='#SoModal'><img src='images/social.ico' width='25'><b> สังคมสงเคราะห์</b></a></div><br>")
                                ...
                                ,$("<div class='col-md-12 col-lg-12'><a id='snap4' class='btn btn-success btn-block' href='#'><img src='images/icon_set2/compose.ico' width='25'><b> บันทึก SNAP-IV</b></a></div><br>")
                                ...
                                ,$("<div class='col-md-12 col-lg-12'><a id='C-case' class='btn btn-success btn-block' href='#'><img src='images/consult.ico' width='25'><b> Consult case</b></a></div>"));
