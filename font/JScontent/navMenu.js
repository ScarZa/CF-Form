$("div#head-nav").empty().append($("<a class='' href='#' id='sidebarCollapse'><img src='images/icon_set2/compose.ico' width='20' class='d-inline-block align-top' alt=''><span style='color: #fff'> Assessment Form.v.1.0</span></a>")
